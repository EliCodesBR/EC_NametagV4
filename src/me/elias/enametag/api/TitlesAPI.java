...
public class TitlesAPI {
	...
	public TitlesAPI(String title) {
		this.title = title;
		loadClasses();
	}

	public TitlesAPI(String title, String subtitle) {
		this.title = title;
		this.subtitle = subtitle;
		loadClasses();
	}

	public TitlesAPI(TitlesAPI title) {
	...
	public TitlesAPI(String title, String subtitle, int fadeInTime, int stayTime, int fadeOutTime) {
		this.title = title;
		this.subtitle = subtitle;
	...
	public static void mandarTitulo(Player p, String titulo, String subtitulo, int duracao) {
		TitlesAPI t = new TitlesAPI(titulo, subtitulo, 0, duracao, duracao);
